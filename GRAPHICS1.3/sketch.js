...
function setup() {
  ...
  character1 = new Character (random(30,width),random(30,height), lime);
  character2 = new Character (random(30,width),random(30,height), robot);
  character3 = new Character (random(30,width),random(30,height), ninja);
}
